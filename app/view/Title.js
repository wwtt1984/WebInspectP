Ext.define('WebInspect.view.Title', {
		...
		tpl:  Ext.create('Ext.XTemplate',
		  '<div style="height:100%;width:100%;">',
              ...
              '<div style="height: 100%; min-width: 100px; float: left; color: #fff;">',
		        ...
		        '<div style="height:50%;margin:6px 0 0 0;width:100%;font-size:15px;">({level})</div>',
              '</div>',
	...
	onDataSet: function(record, user, telephone, level){
		this.setData({user:user, telephone: telephone, level: level, stxt: record.stxt, simg: record.simg, stemperature: record.stemperature});
	}	
});